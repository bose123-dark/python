# Regular Expression (Regex) is a sequence of characters that defines a search pattern used to match, validate, extract, or manipulate text data.

# In Python, a "full match" in a regular expression refers to the scenario where the entire target string, from the first character to the last, matches the given pattern.
